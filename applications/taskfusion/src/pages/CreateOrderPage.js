...
// Structure/layout only — no submission, no upload wiring yet.
// Branch 3 (ROADMAP.md) wires this up: 3.1 asset-service/MinIO for the
// upload field, 3.2 search-service for real tag suggestions, 3.3 the
// comments table (unrelated to this form, but same branch).
