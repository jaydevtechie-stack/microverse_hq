...
| billing-service | Python (Stripe SDK) — payment collection, tells rustledger "payment received"; also consumes elixtempo's tracked time as the basis for analyst/PM payouts (Branch 9, see [docs/business/1.0/overview.md](../../business/1.0/overview.md)) |
